...
{
    public class ASNRepository : ImportRepository, IASNRepository
    {
        public ASNRepository(ITransactionRepository transactionRepository, IRelationRepository relationRepository, ICategoryRepository categoryRepository)
        {
